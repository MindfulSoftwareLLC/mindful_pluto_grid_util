...
**❗ In order to start using Mindful Pluto Grid Util you must have the [Flutter SDK][flutter_install_link] installed on your machine.**

Add `mindful_pluto_grid_util` to your `pubspec.yaml`:

```yaml
dependencies:
  mindful_pluto_grid_util:
```
...
Mindful Pluto Grid Util comes with a built-in [GitHub Actions workflow][github_actions_link] powered by [Very Good Workflows][very_good_workflows_link] but you can also add your preferred CI/CD solution.
